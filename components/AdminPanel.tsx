    ...
    <div className="space-y-10 animate-in fade-in duration-700 pb-12">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
        <div>
          ...
          <p className="text-slate-500 font-bold mt-1">Add or edit classroom events and tasks.</p>
        </div>
        <button 
      ...
      {isAdding && (
        <form ref={formRef} onSubmit={handleSubmit} className="bg-white p-6 md:p-12 rounded-[3rem] border border-slate-100 shadow-2xl space-y-10">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-black text-slate-900">{editingId ? 'Modify Entry' : 'Create New Entry'}</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              <input 
                required
                className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-4 outline-none font-bold focus:border-indigo-500 transition-all shadow-inner"
            ...
            <div className="space-y-3">
              ...
              <select 
                className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-4 outline-none font-black cursor-pointer shadow-inner"
            ...
            <div className="space-y-3">
              ...
              <input 
                className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-4 outline-none font-black shadow-inner"
                ...
                {['exam', 'homework', 'event'].map(type => (
                  <button
                    ...
                    className={`flex-1 py-3 rounded-xl font-black text-[10px] uppercase transition-all ${
                      formData.type === type ? 'bg-white text-indigo-700 shadow-md' : 'text-slate-400'
                    }`}
                  >
                    {t(type)}
                  </button>
          ...
          <div className="space-y-3">
            ...
            <textarea 
              rows={4}
              className="w-full bg-slate-50 border-2 border-slate-100 rounded-3xl px-8 py-6 outline-none resize-none font-bold shadow-inner"
